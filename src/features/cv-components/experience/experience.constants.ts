import { StoredDateRange } from "@shared/types";
...
// new Date("2025.01.01")은 브라우저 구현에 의존하는 파싱이라 사용하지 않는다
export const DEFAULT_DATE_RANGE: StoredDateRange = {
  from: new Date(2025, 0, 1).toISOString(),
  to: new Date(2025, 0, 2).toISOString(),
};
